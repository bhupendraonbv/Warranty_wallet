...
public class StepIndicatorView: UIView {
    ...
    static let defaultColor = UIColor(red: 86.0/255.0, green: 200.0/255.0, blue: 221.0/255.0, alpha: 1.0) //J
    ...
    private func layoutHorizontal() {
        ...
        for i in 0..<self.annularLayers.count {
            ...
            if (i < self.numberOfSteps - 1) {
                ...
                //lineLayer.frame = CGRect(x: CGFloat(i) * stepWidth + diameter + self.lineMargin * 2, y: y - 1, width: stepWidth - diameter - self.lineMargin * 2, height: 3)   /////original code
                lineLayer.frame = CGRect(x: CGFloat(i) * stepWidth + diameter + self.lineMargin, y: y - 1, width: stepWidth - diameter, height: 3)
    ...
    private func applyAnnularStyle(annularLayer:AnnularLayer) {
        ...
        //annularLayer.tintColor = self.circleTintColor///..j
