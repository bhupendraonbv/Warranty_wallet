...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    /// A UIFont value that determines the text font of the title label --Jass Change text animation place holder
    @objc dynamic open var titleFont: UIFont = .systemFont(ofSize: 5) {
        didSet {
            updateTitleLabel()
        }
    }
